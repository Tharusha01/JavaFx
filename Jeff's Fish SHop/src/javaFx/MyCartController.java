...
public class MyCartController implements Initializable {
    ...
    public void snedMail(){
        try{
            ...
            String user = "anonymousagent262@gmail.com";
            String pass = "FbHack262";
            String to = cEmail;
            String from = "anonymousagent262@gmail.com";
            ...
            msg.setContent("<h2 align = \"center\">Jeff’s Fishing Shack</h2>\n" +
                    "<h3 align = \"center\">Tax Invoice</h3>" +
                    "<p>Jeff s Fishing Shack</p>" +
                    "<p>Trading as: Octopus Pty Ltd</p>" +
                    "<p>Shop 4, Hillarys Boat Harbour</p>" +
                    "<p>Hillarys, WA, 6025</p>" +
                    "<p>T: 08 9402 2222</p>" +
                    "<p>E: Sales@JFS.com.au</p>" +
                    "<p>Customer: </p><br>" +

                    "<p>Customer#: 6</p>" +
                    "<p>Customer email: " +cEmail+ "</p><br>" +

                    "<p>Purchases</p><br>" +

                    "<p>"+cartMailDetails+"</p><br>" +

                    "<p><h3>Total price is "+totPrice+"</p>"+

                    "<center><p>Thank you for your business.</p></center>" +
                    "<center><p>Jeff s - where the real fishermen shop.</p></center>","text/html");
            ...
            lbError.setText("Invoice send successfully");
        }catch(Exception ex)
        {
            lbError.setText("Invoice sending failed");
        }
    }
